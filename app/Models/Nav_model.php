...
class Nav_model extends Model
{
    ...
    // Nav program_pendidikan
    public function program_pendidikan()
    {
        $builder = $this->db->table('program_pendidikan');
        $builder->select('program_pendidikan.id_program_pendidikan,  MAX(program_pendidikan.judul_program_pendidikan) AS judul_program_pendidikan, MAX(program_pendidikan.slug_program_pendidikan) AS slug_program_pendidikan, MAX(program_pendidikan.icon) AS icon, MAX(program_pendidikan.ringkasan) AS ringkasan, MAX(program_pendidikan.gambar) AS gambar');
        $builder->where(array('status_program_pendidikan' => 'Publish'));
        $builder->where(array('jenis_program_pendidikan' => 'Program Pendidikan'));
        $builder->groupBy('program_pendidikan.id_program_pendidikan');
        $query = $builder->get();
        return $query->getResult();
    }
