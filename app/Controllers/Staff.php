...
class Staff extends BaseController
{
	...
	public function index()
	{
		...
		$data = [	'title'				=> 'Guru dan Tenaga Pendidik',
					'description'		=> 'Guru dan Tenaga Pendidik '.$konfigurasi->namaweb.', '.$konfigurasi->tentang,
					'keywords'			=> 'Guru dan Tenaga Pendidik '.$konfigurasi->namaweb.', '.$konfigurasi->keywords,
