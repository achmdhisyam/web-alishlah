<!-- /section -->
    <section id="snippet-1" class="wrapper bg-prestasi text-white wrapper-border">
              ...
              <div class="swiper-slide">
                <article>
                  ...
                  <div class="post-header">
                    <div class="post-category text-line text-kategoriprest">
                      <a href="<?php echo base_url('prestasi/kategori/'.$prestasi->slug_kategori_prestasi) ?>" class="hover text-kategoriprest" rel="category"><?php echo $prestasi->nama_kategori_prestasi ?></a>
                    </div>
                    <!-- /.post-category -->
