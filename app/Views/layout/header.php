...
$nav_program_pendidikan = $m_nav->program_pendidikan();
$nav_menu               = $m_nav->menu();
          ...
          <div class="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
            ...
            <div class="offcanvas-body ms-lg-auto d-flex flex-column h-100">
                  ...
                  <ul class="dropdown-menu mega-menu mega-menu-dark">
                    <li class="mega-menu-content">
                      <div class="row gx-0 gx-lg-3">
                        <div class="col-lg-4">
                          <h6 class="dropdown-header text-warning">Profil & Guru </h6>
                          <ul class="list-unstyled pb-lg-1">
                            <li><a class="dropdown-item" href="<?php echo base_url('profil/sejarah') ?>">Sejarah Sekolah</a></li>
                            <li><a class="dropdown-item" href="<?php echo base_url('profil/visi_misi') ?>">Visi &amp; Misi</a></li>
                            <li><a class="dropdown-item" href="<?php echo base_url('profil/sambutan') ?>">Sambutan Kepala Sekolah</a></li>
                            <li><a class="dropdown-item" href="<?php echo base_url('staff') ?>">Tendik <?php echo $this->website->namaweb() ?></a></li>
                          </ul>
              ...
              <?php }  if($site_setting->letak_menu=='Jenjang') { echo $menu_tambahan; }  if($site_setting->menu_jenjang=='Publish') { ?>
                <li class="nav-item dropdown">
                  <a class="nav-link text-uppercase dropdown-toggle" href="#" data-bs-toggle="dropdown">Program Pendidikan</a>
                  <ul class="dropdown-menu bg-dark">
                    
                    <?php foreach($nav_program_pendidikan as $nav_program_pendidikan) { ?>
                    <li><a class="dropdown-item text-white" href="<?php echo base_url('program_pendidikan/read/'.$nav_program_pendidikan->slug_program_pendidikan) ?>"><?php echo $nav_program_pendidikan->judul_program_pendidikan ?></a></li>
                    <?php } ?>
                    <li><a class="dropdown-item text-warning"  href="<?php echo base_url('program_pendidikan') ?>">Semua Program</a></li>
              ...
              <div class="offcanvas-footer d-lg-none">
                <div>
                  ...
                  <br /><a href="https://api.whatsapp.com/send?phone=<?php echo $site_setting->hp ?>" class="text-white hover" target="_blank"> <?php echo $site_setting->hp ?> </a> <br />
