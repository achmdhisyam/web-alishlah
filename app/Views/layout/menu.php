                                            ...
                                            <ul>
                                                ...
                                                <li class="menu-item-has-children mega-menu-wrap">
                                                    ...
                                                    <ul class="mega-menu  mega-menu mega-menu-dark">
                                                         <li><a href="<?php echo base_url('profil/sejarah') ?>">Profil Kami</a>
                                                             <ul>
                                                                 ...
                                                                 <li><a href="<?php echo base_url('profil/sambutan') ?>">Sambutan Kepala Sekolah</a></li>
                                                                 <li><a href="<?php echo base_url('staff') ?>">Guru &amp; Staff</a></li>
                                                             </ul>
                                                         </li>
