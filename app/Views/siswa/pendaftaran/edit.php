        ...
        <div class="card mb-2">
          ...
          <div class="card-body">
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <input type="text" name="nama_siswa" class="form-control form-control-lg" placeholder="Nama lengkap siswa" value="<?php echo set_value('nama_siswa', $siswa->nama_siswa); ?>" required>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <input type="text" name="nama_panggilan" class="form-control" placeholder="Nama panggilan" value="<?php echo set_value('nama_panggilan', $siswa->nama_panggilan); ?>" required>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-4">
                <input type="text" name="nis" class="form-control" placeholder="Nomor Induk Siswa (NIS)" value="<?php echo set_value('nis', $siswa->nis); ?>">
                <small class="text-warning">Nomor Induk Siswa (NIS) atau kosongkan</small>
              </div>
              <div class="col-md-5">
                <input type="text" name="nisn" class="form-control" placeholder="Nomor Induk Siswa Nasional (NISN)" value="<?php echo set_value('nisn', $siswa->nisn); ?>" required>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-3">
                <input type="text" name="negara_asal" class="form-control" value="<?php echo set_value('negara_asal', $siswa->negara_asal); ?>" placeholder="Negara asal (jika WNA)">
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                  <select name="jenis_kelamin" class="form-control form-select" required>
                    ...
                    <option value="L" <?php if(set_value('jenis_kelamin')=='L') { echo 'selected'; }elseif($siswa->jenis_kelamin=='L') { echo 'selected'; } ?>>Laki-laki</option>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-3">
                <input type="number" name="anak_ke" class="form-control" placeholder="Anak nomor ke?" value="<?php echo set_value('anak_ke', $siswa->anak_ke); ?>" required>
                <small class="text-secondary">Anak nomor ke</small>
              </div>
              <div class="col-md-3">
                <input type="number" name="jumlah_saudara" class="form-control" placeholder="Jumlah saudara" value="<?php echo set_value('jumlah_saudara', $siswa->jumlah_saudara); ?>" required>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-5">
                <input type="text" name="tempat_lahir" class="form-control" placeholder="Tempat lahir" value="<?php echo set_value('tempat_lahir', $siswa->tempat_lahir); ?>" required>
                <small class="text-warning">Tempat lahir</small>
              </div>
              <div class="col-md-4">
                <input type="text" name="tanggal_lahir" class="form-control tanggal" placeholder="dd-mm-yyyy" value="<?php echo set_value('tanggal_lahir', $this->website->tanggal_id($siswa->tanggal_lahir)); ?>" required>
        ...
        <div class="card mb-2">
          ...
          <div class="card-body">
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <textarea name="alamat" placeholder="Nama Jalan, Blok, No. Rumah, Kelurahan/Desa" class="form-control" rows="2" required><?php echo set_value('alamat', $siswa->alamat); ?></textarea>
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-4">
                <input type="text" name="rt" class="form-control" placeholder="RT (contoh: 001)" value="<?php echo set_value('rt', $siswa->rt); ?>" required>
              </div>
              <div class="col-md-5">
                <input type="text" name="rw" class="form-control" placeholder="RW (contoh: 002)" value="<?php echo set_value('rw', $siswa->rw); ?>" required>
              </div>
            </div>
              ...
              <div class="col-md-9">
                <select name="provinsi" id="provinsi" class="form-control form-select select2" required>
                  ...
                  <?php if (!empty($siswa->provinsi)) { ?>
                    <option value="<?= esc($siswa->provinsi) ?>" selected><?= esc($siswa->provinsi) ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-5">
                <select name="kabupaten" id="kabupaten" class="form-control form-select select2" required>
                  ...
                  <?php if (!empty($siswa->kabupaten)) { ?>
                    <option value="<?= esc($siswa->kabupaten) ?>" selected><?= esc($siswa->kabupaten) ?></option>
                  <?php } ?>
                </select>
              </div>
              <div class="col-md-4">
                <select name="kecamatan" id="kecamatan" class="form-control form-select select2" required>
                  ...
                  <?php if (!empty($siswa->kecamatan)) { ?>
                    <option value="<?= esc($siswa->kecamatan) ?>" selected><?= esc($siswa->kecamatan) ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
              ...
              <div class="col-md-9">
                <select name="kelurahan" id="kelurahan" class="form-control form-select select2" required>
                  ...
                  <?php if (!empty($siswa->kelurahan)) { ?>
                    <option value="<?= esc($siswa->kelurahan) ?>" selected><?= esc($siswa->kelurahan) ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <input type="text" id="kode_pos" name="kode_pos" class="form-control" placeholder="" value="<?php echo set_value('kode_pos', $siswa->kode_pos); ?>">
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-4">
                <input type="text" name="telepon" class="form-control" placeholder="Telepon/HP" value="<?php echo set_value('telepon', $siswa->telepon); ?>" required>
                <small class="text-warning">Telepon/HP</small>
              </div>
              <div class="col-md-5">
                <input type="email" name="email" class="form-control" placeholder="Email" value="<?php echo set_value('email', $siswa->email ?: $siswa->email_akun); ?>" required>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <input type="file" name="gambar" class="form-control" placeholder="Gambar/Foto" value="<?php echo set_value('gambar', $siswa->gambar); ?>">
              </div>
            </div>
        ...
        <div class="card mb-2">
          ...
          <div class="card-body">
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <input type="text" name="asal_sekolah" class="form-control" placeholder="Nama Sekolah Asal (Tamatan Dari)" value="<?php echo set_value('asal_sekolah', $siswa->asal_sekolah); ?>">
              </div>
            </div>
        ...
        <div class="card mb-2">
          ...
          <div class="card-body">
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <input type="text" name="nama_ayah" class="form-control" placeholder="Nama Ayah" value="<?php echo set_value('nama_ayah', $siswa->nama_ayah); ?>" required>
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-5">
                <input type="text" name="tempat_lahir_ayah" class="form-control" placeholder="Tempat lahir ayah" value="<?php echo set_value('tempat_lahir_ayah', $siswa->tempat_lahir_ayah); ?>">
              </div>
              <div class="col-md-4">
                <input type="text" name="tanggal_lahir_ayah" class="form-control tanggal" placeholder="dd-mm-yyyy" value="<?php echo set_value('tanggal_lahir_ayah', $siswa->tanggal_lahir_ayah); ?>">
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <input type="text" name="penghasilan_ayah" class="form-control" placeholder="Rp." value="<?php echo set_value('penghasilan_ayah', $siswa->penghasilan_ayah); ?>">
              </div>
            </div>
            <div class="form-group row mb-3">
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                ...
                <textarea name="alamat_ayah" id="alamat_ayah" placeholder="Nama Jalan, Blok, No. Rumah, Kelurahan/Desa" class="form-control" rows="2" required><?php echo set_value('alamat_ayah', isset($siswa) ? $siswa->alamat_ayah : ''); ?></textarea>
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-4">
                <input type="text" name="rt_ayah" id="rt_ayah" class="form-control" placeholder="RT (contoh: 001)" value="<?php echo set_value('rt_ayah', isset($siswa) ? $siswa->rt_ayah : ''); ?>" required>
              </div>
              <div class="col-md-5">
                <input type="text" name="rw_ayah" id="rw_ayah" class="form-control" placeholder="RW (contoh: 002)" value="<?php echo set_value('rw_ayah', isset($siswa) ? $siswa->rw_ayah : ''); ?>" required>
              </div>
            </div>
              ...
              <div class="col-md-9">
                <select name="provinsi_ayah" id="provinsi_ayah" class="form-control form-select select2" required>
                  ...
                  <?php if (!empty($siswa->provinsi_ayah)) { ?>
                    <option value="<?= esc($siswa->provinsi_ayah) ?>" selected><?= esc($siswa->provinsi_ayah) ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-5">
                <select name="kabupaten_ayah" id="kabupaten_ayah" class="form-control form-select select2" required>
                  <option value="">Pilih Kabupaten / Kota</option>
                  <?php if (!empty($siswa->kabupaten_ayah)) { ?>
                    <option value="<?= esc($siswa->kabupaten_ayah) ?>" selected><?= esc($siswa->kabupaten_ayah) ?></option>
                  <?php } ?>
                </select>
              </div>
              <div class="col-md-4">
                <select name="kecamatan_ayah" id="kecamatan_ayah" class="form-control form-select select2" required>
                  <option value="">Pilih Kecamatan</option>
                  <?php if (!empty($siswa->kecamatan_ayah)) { ?>
                    <option value="<?= esc($siswa->kecamatan_ayah) ?>" selected><?= esc($siswa->kecamatan_ayah) ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <select name="kelurahan_ayah" id="kelurahan_ayah" class="form-control form-select select2" required>
                  <option value="">Pilih Kelurahan / Desa</option>
                  <?php if (!empty($siswa->kelurahan_ayah)) { ?>
                    <option value="<?= esc($siswa->kelurahan_ayah) ?>" selected><?= esc($siswa->kelurahan_ayah) ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <input type="text" id="kode_pos_ayah" name="kode_pos_ayah" class="form-control" placeholder="" value="<?php echo set_value('kode_pos_ayah', isset($siswa) ? $siswa->kode_pos_ayah : ''); ?>">
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <input type="text" name="telepon_ayah" class="form-control" placeholder="Telepon/HP Ayah" value="<?php echo set_value('telepon_ayah', $siswa->telepon_ayah); ?>" required>
              </div>
            </div>
        ...
        <div class="card mb-2">
          ...
          <div class="card-body">
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <input type="text" name="nama_ibu" class="form-control" placeholder="Nama Ibu" value="<?php echo set_value('nama_ibu', $siswa->nama_ibu); ?>" required>
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-5">
                <input type="text" name="tempat_lahir_ibu" class="form-control" placeholder="Tempat lahir ibu" value="<?php echo set_value('tempat_lahir_ibu', $siswa->tempat_lahir_ibu); ?>">
              </div>
              <div class="col-md-4">
                <input type="text" name="tanggal_lahir_ibu" class="form-control tanggal" placeholder="dd-mm-yyyy" value="<?php echo set_value('tanggal_lahir_ibu', $siswa->tanggal_lahir_ibu); ?>">
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <input type="text" name="penghasilan_ibu" class="form-control" placeholder="Rp." value="<?php echo set_value('penghasilan_ibu', $siswa->penghasilan_ibu); ?>">
              </div>
            </div>
            <div class="form-group row mb-3">
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                ...
                <textarea name="alamat_ibu" id="alamat_ibu" placeholder="Nama Jalan, Blok, No. Rumah, Kelurahan/Desa" class="form-control" rows="2" required><?php echo set_value('alamat_ibu', isset($siswa) ? $siswa->alamat_ibu : ''); ?></textarea>
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-4">
                <input type="text" name="rt_ibu" id="rt_ibu" class="form-control" placeholder="RT (contoh: 001)" value="<?php echo set_value('rt_ibu', isset($siswa) ? $siswa->rt_ibu : ''); ?>" required>
              </div>
              <div class="col-md-5">
                <input type="text" name="rw_ibu" id="rw_ibu" class="form-control" placeholder="RW (contoh: 002)" value="<?php echo set_value('rw_ibu', isset($siswa) ? $siswa->rw_ibu : ''); ?>" required>
              </div>
            </div>
              ...
              <div class="col-md-9">
                <select name="provinsi_ibu" id="provinsi_ibu" class="form-control form-select select2" required>
                  ...
                  <?php if (!empty($siswa->provinsi_ibu)) { ?>
                    <option value="<?= esc($siswa->provinsi_ibu) ?>" selected><?= esc($siswa->provinsi_ibu) ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-5">
                <select name="kabupaten_ibu" id="kabupaten_ibu" class="form-control form-select select2" required>
                  <option value="">Pilih Kabupaten / Kota</option>
                  <?php if (!empty($siswa->kabupaten_ibu)) { ?>
                    <option value="<?= esc($siswa->kabupaten_ibu) ?>" selected><?= esc($siswa->kabupaten_ibu) ?></option>
                  <?php } ?>
                </select>
              </div>
              <div class="col-md-4">
                <select name="kecamatan_ibu" id="kecamatan_ibu" class="form-control form-select select2" required>
                  <option value="">Pilih Kecamatan</option>
                  <?php if (!empty($siswa->kecamatan_ibu)) { ?>
                    <option value="<?= esc($siswa->kecamatan_ibu) ?>" selected><?= esc($siswa->kecamatan_ibu) ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <select name="kelurahan_ibu" id="kelurahan_ibu" class="form-control form-select select2" required>
                  <option value="">Pilih Kelurahan / Desa</option>
                  <?php if (!empty($siswa->kelurahan_ibu)) { ?>
                    <option value="<?= esc($siswa->kelurahan_ibu) ?>" selected><?= esc($siswa->kelurahan_ibu) ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <input type="text" id="kode_pos_ibu" name="kode_pos_ibu" class="form-control" placeholder="" value="<?php echo set_value('kode_pos_ibu', isset($siswa) ? $siswa->kode_pos_ibu : ''); ?>">
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <input type="text" name="telepon_ibu" class="form-control" placeholder="Telepon/HP Ibu" value="<?php echo set_value('telepon_ibu', $siswa->telepon_ibu); ?>" required>
              </div>
            </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <input type="text" name="nama_wali" class="form-control" placeholder="Nama Wali" value="<?php echo set_value('nama_wali', $siswa->nama_wali); ?>" >
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-5">
                <input type="text" name="tempat_lahir_wali" class="form-control" placeholder="Tempat lahir wali" value="<?php echo set_value('tempat_lahir_wali', $siswa->tempat_lahir_wali); ?>">
              </div>
              <div class="col-md-4">
                <input type="text" name="tanggal_lahir_wali" class="form-control tanggal" placeholder="dd-mm-yyyy" value="<?php echo set_value('tanggal_lahir_wali', $siswa->tanggal_lahir_wali); ?>">
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <input type="text" name="penghasilan_wali" class="form-control" placeholder="Rp." value="<?php echo set_value('penghasilan_wali', $siswa->penghasilan_wali); ?>">
              </div>
            </div>
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                ...
                <textarea name="alamat_wali" id="alamat_wali" placeholder="Nama Jalan, Blok, No. Rumah, Kelurahan/Desa" class="form-control" rows="2"><?php echo set_value('alamat_wali', isset($siswa) ? $siswa->alamat_wali : ''); ?></textarea>
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-4">
                <input type="text" name="rt_wali" id="rt_wali" class="form-control" placeholder="RT (contoh: 001)" value="<?php echo set_value('rt_wali', isset($siswa) ? $siswa->rt_wali : ''); ?>">
              </div>
              <div class="col-md-5">
                <input type="text" name="rw_wali" id="rw_wali" class="form-control" placeholder="RW (contoh: 002)" value="<?php echo set_value('rw_wali', isset($siswa) ? $siswa->rw_wali : ''); ?>">
              </div>
            </div>
              ...
              <div class="col-md-9">
                <select name="provinsi_wali" id="provinsi_wali" class="form-control form-select select2">
                  ...
                  <?php if (!empty($siswa->provinsi_wali)) { ?>
                    <option value="<?= esc($siswa->provinsi_wali) ?>" selected><?= esc($siswa->provinsi_wali) ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-5">
                <select name="kabupaten_wali" id="kabupaten_wali" class="form-control form-select select2">
                  <option value="">Pilih Kabupaten / Kota</option>
                  <?php if (!empty($siswa->kabupaten_wali)) { ?>
                    <option value="<?= esc($siswa->kabupaten_wali) ?>" selected><?= esc($siswa->kabupaten_wali) ?></option>
                  <?php } ?>
                </select>
              </div>
              <div class="col-md-4">
                <select name="kecamatan_wali" id="kecamatan_wali" class="form-control form-select select2">
                  <option value="">Pilih Kecamatan</option>
                  <?php if (!empty($siswa->kecamatan_wali)) { ?>
                    <option value="<?= esc($siswa->kecamatan_wali) ?>" selected><?= esc($siswa->kecamatan_wali) ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <select name="kelurahan_wali" id="kelurahan_wali" class="form-control form-select select2">
                  <option value="">Pilih Kelurahan / Desa</option>
                  <?php if (!empty($siswa->kelurahan_wali)) { ?>
                    <option value="<?= esc($siswa->kelurahan_wali) ?>" selected><?= esc($siswa->kelurahan_wali) ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <input type="text" id="kode_pos_wali" name="kode_pos_wali" class="form-control" placeholder="" value="<?php echo set_value('kode_pos_wali', isset($siswa) ? $siswa->kode_pos_wali : ''); ?>">
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <input type="text" name="telepon_wali" class="form-control" placeholder="Telepon/HP Wali" value="<?php echo set_value('telepon_wali', $siswa->telepon_wali); ?>" >
              </div>
            </div>
          ...
          <div class="card mb-2">
            ...
            <div class="card-footer bg-light border-top">
              <div class="d-flex justify-content-between">
                <button type="button" class="btn btn-outline-secondary rounded-pill px-4" onclick="prevStep()"><i class="fa fa-arrow-left"></i> Kembali</button>
                <button type="submit" id="btnSubmitForm" class="btn btn-success text-white rounded-pill px-4" name="submit" value="submit" disabled><i class="fa fa-save"></i>&nbsp;Simpan dan Lanjutkan Pendaftaran</button>
              </div>
            </div>
          </div>
        </div> <!-- Close Step 4 -->
