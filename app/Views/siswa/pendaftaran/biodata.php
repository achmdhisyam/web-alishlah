        ...
        <div class="card mb-2">
          ...
          <div class="card-body">
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <textarea name="alamat_ayah" placeholder="Alamat Ayah" class="form-control" required><?php echo set_value('alamat_ayah') ?></textarea>
              </div>
            </div>
        ...
        <div class="card mb-2">
          ...
          <div class="card-body">
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <textarea name="alamat_ibu" placeholder="Alamat Ibu" class="form-control" required><?php echo set_value('alamat_ibu') ?></textarea>
              </div>
            </div>
