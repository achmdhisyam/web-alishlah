...
<div class="form-group row">
	...
	<div class="col-9">
		<select name="akses_level" class="form-control">
			...
			<option value="spmb" <?php if($user->akses_level=="spmb") { echo 'selected'; } ?>>spmb</option>
			<option value="konten" <?php if($user->akses_level=="konten") { echo 'selected'; } ?>>konten</option>
		</select>
	</div>
</div>
