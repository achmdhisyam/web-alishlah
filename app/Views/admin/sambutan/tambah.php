...
<form action="<?php echo base_url('admin/sambutan/tambah') ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
<?php 
echo csrf_field(); 
?>
...
<div class="form-group row">
	...
	<div class="col-md-10">
		<input type="text" name="judul_sambutan" class="form-control" placeholder="Contoh: Dr. H. Ahmad, M.Pd. (Kepala Sekolah)" value="<?php echo set_value('judul_sambutan') ?>" required>
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-md-10">
		...
		<small class="text-secondary">Pilih foto formal Kepala Sekolah</small>
	</div>
</div>
