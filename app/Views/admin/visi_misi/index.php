<div class="row">
	<div class="col-md-6">
		<?php echo form_open(base_url('admin/visi_misi'), ' method="get"') ?>
		<div class="input-group">
          ...
          <span class="input-group-append">
            ...
            <a href="<?php echo base_url('admin/visi_misi/tambah') ?>" class="btn btn-info">
...
<?php echo form_open(base_url('admin/visi_misi/proses')) ?>
<input type="hidden" name="pengalihan" value="<?php echo str_replace('index.php','',CURRENT_URL()) ?>">
<div class="mailbox-controls">

	<button type="submit" name="submit" value="Delete" class="btn btn-secondary btn-sm" title="Hapus Visi & Misi">
...
<table class="tabelku table-sm" id="example2">
	<thead>
		<tr class="text-left bg-light">
			...
			<th width="50%">Judul Visi &amp; Misi</th>
	...
	<tbody>
		<?php $no=1; foreach($visi_misi as $item) { ?>
		<tr>
			<td class="text-center">
				<div class="icheck-primary">
          <input type="checkbox" name="id_visi_misi[]" value="<?php echo $item->id_visi_misi ?>" id="check_<?php echo $no ?>">
          <label for="check_<?php echo $no ?>"></label>
			...
			<td><a href="<?php echo base_url('admin/visi_misi/edit/'.$item->id_visi_misi) ?>">
					<?php echo $item->judul_visi_misi ?>
				</a>
				<small>
			...
			<td><small>
				<i class="fa fa-user"></i> <a href="<?php echo base_url('admin/visi_misi/author/'.$item->id_user) ?>">
						<?php echo $item->nama ?>
					</a>
			</small>
			</td>
			<td>
				<a href="<?php echo base_url('admin/visi_misi/status_visi_misi/'.$item->status_visi_misi) ?>">
				<?php if($item->status_visi_misi=='Publish') { ?>
					<span class="badge bg-info">
						<i class="fa fa-eye"></i> <?php echo $item->status_visi_misi ?>
					</span>
				<?php }else{ ?>
			...
			<td>
				<a href="<?php echo base_url('admin/visi_misi/edit/'.$item->id_visi_misi) ?>" class="btn btn-secondary btn-xs mt-1" title="Edit"><i class="fa fa-edit"></i></a>
				<a href="<?php echo base_url('admin/visi_misi/delete/'.$item->id_visi_misi) ?>" class="btn btn-secondary btn-xs mt-1 delete-link" title="Hapus"><i class="fa fa-trash"></i></a>
			</td>
		</tr>
		<?php $no++; } ?>
	</tbody>
