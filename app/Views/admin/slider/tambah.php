...
<form action="<?php echo base_url('admin/slider/tambah') ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
<?php 
echo csrf_field(); 
?>
...
<div class="form-group row">
	...
	<div class="col-md-9">
		<input type="text" name="judul_slider" class="form-control" value="<?php echo set_value('judul_slider') ?>" required>
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-md-9">
		...
		<small class="text-muted">Rekomendasi ukuran gambar slider: 1920x800 piksel</small>
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-md-9">
		<select name="status_text" class="form-control">
			<option value="Ya">Aktif (Tampilkan Teks)</option>
			<option value="Tidak">Tidak Aktif (Sembunyikan Teks)</option>
		</select>
...
<div class="form-group row">
	...
	<div class="col-md-9">
		<input type="text" name="text_website" class="form-control" value="<?php echo set_value('text_website') ?>" placeholder="Contoh: Selengkapnya, Info Pendaftaran, dll">
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-md-9">
		<input type="text" name="website" class="form-control" value="<?php echo set_value('website') ?>" placeholder="Contoh: https://example.com/spmb">
	</div>
</div>
