      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <!-- SPMB -->
          <?php if($this->website->fitur_pendaftaran()=='On') if (Session()->get('akses_level')=='spmb' || Session()->get('akses_level')=='Admin') { ?>
         ...
         <!-- berita -->
          ...
          <!-- program_pendidikan -->
          <li class="nav-item <?php if($uri->getSegment(2)=="program_pendidikan" || $uri->getSegment(2)=="kategori"){echo 'menu-open';}?>">
            <a href="#" class="nav-link <?php if($uri->getSegment(2)=="program_pendidikan" || $uri->getSegment(2)=="kategori"){echo 'active';}?>">
