...
<div class="card">
	...
	<div class="card-body">
		...
		<div class="form-group row">
			<label class="col-3">NIS dan NISN<span class="text-danger">*</span></label>
			<div class="col-3">
			...
			<div class="col-2">
				...
				<select name="id_agama" class="form-control select2" required>
					<?php foreach($agama as $ag) { ?>
						<option value="<?php echo $ag->id_agama ?>" <?php if(set_value('id_agama')==$ag->id_agama) { echo 'selected'; } ?>>
			...
			<div class="col-2">
				...
				<select name="id_hubungan" class="form-control select2" required>
					<?php foreach($hubungan as $hub) { ?>
						<option value="<?php echo $hub->id_hubungan ?>" <?php if(set_value('id_hubungan')==$hub->id_hubungan) { echo 'selected'; } ?>>
		...
		<div class="form-group row">
			...
			<div class="col-9">
				<textarea name="alamat" placeholder="Nama Jalan, Blok, No. Rumah, Kelurahan/Desa" class="form-control" required><?php echo set_value('alamat') ?></textarea>
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-6">
				<input type="text" id="kode_pos" name="kode_pos" class="form-control" placeholder="" value="<?php echo set_value('kode_pos') ?>">
			</div>
		</div>
			...
			<div class="col-6">
				...
				<select name="id_tahun" class="form-control select2" required>
					...
					<?php foreach($tahun as $th) { ?>
						<option value="<?php echo $th->id_tahun ?>" <?php if(set_value('id_tahun')==$th->id_tahun) { echo 'selected'; } ?>>
			...
			<div class="col-6">
				...
				<select name="id_jenjang" class="form-control select2" required>
					...
					<?php foreach($jenjang as $jg) { ?>
						<option value="<?php echo $jg->id_jenjang ?>" <?php if(set_value('id_jenjang')==$jg->id_jenjang) { echo 'selected'; } ?>>
			...
			<div class="col-6">
				...
				<select name="id_kelas" class="form-control select2" required>
					...
					<?php foreach($kelas as $kl) { ?>
						<option value="<?php echo $kl->id_kelas ?>" <?php if(set_value('id_kelas')==$kl->id_kelas) { echo 'selected'; } ?>>
	...
	<div class="card-body">
		...
		<div class="form-group row">
			...
			<div class="col-6">
				...
				<textarea name="alamat_ayah" id="alamat_ayah" placeholder="Nama Jalan, Blok, No. Rumah, Kelurahan/Desa" class="form-control" rows="2" required><?php echo set_value('alamat_ayah') ?></textarea>
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-3">
				<input type="text" name="rt_ayah" id="rt_ayah" class="form-control" placeholder="RT (contoh: 001)" value="<?php echo set_value('rt_ayah') ?>" required>
			</div>
			<div class="col-3">
				<input type="text" name="rw_ayah" id="rw_ayah" class="form-control" placeholder="RW (contoh: 002)" value="<?php echo set_value('rw_ayah') ?>" required>
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-6">
				<input type="text" id="kode_pos_ayah" name="kode_pos_ayah" class="form-control" placeholder="" value="<?php echo set_value('kode_pos_ayah') ?>">
			</div>
		</div>
	...
	<div class="card-body">
		...
		<div class="form-group row">
			...
			<div class="col-6">
				...
				<textarea name="alamat_ibu" id="alamat_ibu" placeholder="Nama Jalan, Blok, No. Rumah, Kelurahan/Desa" class="form-control" rows="2" required><?php echo set_value('alamat_ibu') ?></textarea>
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-3">
				<input type="text" name="rt_ibu" id="rt_ibu" class="form-control" placeholder="RT (contoh: 001)" value="<?php echo set_value('rt_ibu') ?>" required>
			</div>
			<div class="col-3">
				<input type="text" name="rw_ibu" id="rw_ibu" class="form-control" placeholder="RW (contoh: 002)" value="<?php echo set_value('rw_ibu') ?>" required>
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-6">
				<input type="text" id="kode_pos_ibu" name="kode_pos_ibu" class="form-control" placeholder="" value="<?php echo set_value('kode_pos_ibu') ?>">
			</div>
		</div>
	...
	<div class="card-body">
		...
		<div class="form-group row">
			...
			<div class="col-3">
				<div class="form-group">
					<div class="custom-control custom-radio">
						<input class="custom-control-input" name="identitas_wali" type="radio" id="identitas_wali1" value="Ayah" onclick="Ayah()" <?php if(set_value('identitas_wali')=='Ayah') { echo 'checked'; } ?> required>
						<label for="identitas_wali1" class="custom-control-label">Sama dengan Ayah</label>
					</div>
					<div class="custom-control custom-radio">
						<input class="custom-control-input" name="identitas_wali" type="radio" id="identitas_wali2" value="Ibu" onclick="Ibu()" <?php if(set_value('identitas_wali')=='Ibu') { echo 'checked'; } ?> required>
						<label for="identitas_wali2" class="custom-control-label">Sama dengan Ibu</label>
					</div>
					<div class="custom-control custom-radio">
						<input class="custom-control-input" name="identitas_wali" type="radio" id="identitas_wali3" value="Berbeda" onclick="Berbeda()" <?php if(set_value('identitas_wali')=='Berbeda') { echo 'checked'; }else{ echo 'checked'; } ?> required>
		...
		<div id="myDIV" style="display: <?php if(set_value('identitas_wali') == 'Ayah' || set_value('identitas_wali') == 'Ibu') { echo 'none'; }else{ echo 'block'; } ?>;">
			...
			<div class="form-group row">
				...
				<div class="col-6">
					...
					<textarea name="alamat_wali" id="alamat_wali" placeholder="Nama Jalan, Blok, No. Rumah, Kelurahan/Desa" class="form-control" rows="2"><?php echo set_value('alamat_wali') ?></textarea>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-3">
					<input type="text" name="rt_wali" id="rt_wali" class="form-control" placeholder="RT (contoh: 001)" value="<?php echo set_value('rt_wali') ?>">
				</div>
				<div class="col-3">
					<input type="text" name="rw_wali" id="rw_wali" class="form-control" placeholder="RW (contoh: 002)" value="<?php echo set_value('rw_wali') ?>">
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-6">
					<input type="text" id="kode_pos_wali" name="kode_pos_wali" class="form-control" placeholder="" value="<?php echo set_value('kode_pos_wali') ?>">
				</div>
			</div>
