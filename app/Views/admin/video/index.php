	...
	<tbody>
		...
		<tr>
			...
			<td class="text-center">
				<img src="<?php echo $this->website->youtube_thumbnail($video->video,$video->gambar) ?>" class="img img-thumbnail" style="max-width: 100px;">
			</td>
			...
			<td>
				<div class="embed-responsive embed-responsive-16by9">
				  <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/<?php echo $this->website->youtube_id($video->video) ?>?rel=0" allowfullscreen></iframe>
				</div>
			</td>
			<td>
