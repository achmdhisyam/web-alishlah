...
<form action="<?php echo base_url('admin/yayasan/tambah') ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
<?php 
echo csrf_field(); 
?>
...
<div class="form-group row">
	...
	<div class="col-md-10">
		<input type="text" name="judul_yayasan" class="form-control" value="<?php echo set_value('judul_yayasan') ?>" required>
	</div>
</div>
