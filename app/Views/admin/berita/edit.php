...
<div class="form-group row">
	...
	<div class="col-md-3">
		<select name="id_kategori" class="form-control">
			...
			?>
			<option value="<?php echo $kat->id_kategori ?>" <?php if($berita->id_kategori==$kat->id_kategori) { echo 'selected'; } ?>>
...
<div class="form-group row">
	...
	<div class="col-md-10">
		...
		<textarea id="isi" name="isi" class="form-control konten"><?php echo $berita->isi ?></textarea>
	</div>
</div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if(btnAi) {
        btnAi.addEventListener('click', function() {
            ...
            // Dapatkan teks mentah dari TinyMCE
            let draftIsi = '';
