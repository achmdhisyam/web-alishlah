        ...
        <div class="card mb-2">
          ...
          <div class="card-body">
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-5">
                <input type="text" name="nisn" class="form-control" placeholder="Nomor Induk Siswa Nasional (NISN)" value="<?php if(isset($_POST['submit'])) { echo set_value('nisn'); }else{ echo $siswa->nisn; } ?>" required>
              ...
              <div class="col-md-3">
                ...
                <select name="id_agama" class="form-control form-select" required>
                  <?php foreach($agama as $ag) { ?>
                    <option value="<?php echo $ag->id_agama ?>" <?php if(set_value('id_agama')==$ag->id_agama) { echo 'selected'; }elseif($ag->id_agama==$siswa->id_agama) { echo 'selected'; } ?>>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <textarea name="alamat" placeholder="Nama Jalan, Blok, No. Rumah, Kelurahan/Desa" class="form-control" rows="2" required><?php if(isset($_POST['submit'])) { echo set_value('alamat'); }else{ echo $siswa->alamat; } ?></textarea>
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-4">
                <input type="text" name="rt" class="form-control" placeholder="RT (contoh: 001)" value="<?php if(isset($_POST['submit'])) { echo set_value('rt'); }else{ echo $siswa->rt; } ?>" required>
              </div>
              <div class="col-md-5">
                <input type="text" name="rw" class="form-control" placeholder="RW (contoh: 002)" value="<?php if(isset($_POST['submit'])) { echo set_value('rw'); }else{ echo $siswa->rw; } ?>" required>
              </div>
            </div>
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <input type="text" id="kode_pos" name="kode_pos" class="form-control" placeholder="" value="<?php if(isset($_POST['submit'])) { echo set_value('kode_pos'); }else{ echo $siswa->kode_pos; } ?>">
              </div>
            </div>
