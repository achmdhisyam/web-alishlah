                  ...
                  <?php foreach($program_pendidikan as $jp) { ?>
                    <?php if($jp->jenis_program_pendidikan == 'Program Pendidikan') { ?> 
                      <option value="<?php echo $jp->id_program_pendidikan ?>" 
                        <?php if(set_value('id_program_pendidikan')==$jp->id_program_pendidikan) { echo 'selected'; }elseif($jp->id_program_pendidikan==$siswa->id_program_pendidikan) { echo 'selected'; } ?>>
              ...
              <div class="col-md-3">
                ...
                <select name="id_hubungan" class="form-control  form-select" required>
                  <?php foreach($hubungan as $hubungan) { ?>
                    <option value="<?php echo $hubungan->id_hubungan ?>" <?php if(set_value('id_hubungan')==$hubungan->id_hubungan) { echo 'selected'; }elseif($hubungan->id_hubungan==$siswa->id_hubungan) { echo 'selected'; } ?>>
        ...
        <div class="card mb-2">
          ...
          <div class="card-body">
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <input type="text" name="telepon_ayah" class="form-control" placeholder="Telepon/HP Ayah" value="<?php if(isset($_POST['submit'])) { echo set_value('telepon_ayah'); }else{ echo $siswa->telepon_ayah; } ?>">
              </div>
            </div>
        ...
        <div class="card mb-2">
          ...
          <div class="card-body">
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-md-9">
                <input type="text" name="telepon_ibu" class="form-control" placeholder="Telepon/HP Ibu" value="<?php if(isset($_POST['submit'])) { echo set_value('telepon_ibu'); }else{ echo $siswa->telepon_ibu; } ?>">
              </div>
            </div>
          ...
          <div class="card-body">
            ...
            <div id="myDIV">
              ...
              <div class="form-group row mb-3">
                ...
                <div class="col-md-9">
                  <input type="text" name="telepon_wali" class="form-control" placeholder="Telepon/HP Wali" value="<?php if(isset($_POST['submit'])) { echo set_value('telepon_wali'); }else{ echo $siswa->telepon_wali; } ?>" required>
                </div>
              </div>
            </div>
