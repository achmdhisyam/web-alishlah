...
<div class="form-group row">
	...
	<div class="col-9">
		<textarea id="isi"name="tentang" class="form-control konten" rows="5"><?php echo $konfigurasi->tentang ?></textarea>
	</div>
</div>

<div class="form-group row">
	<label class="col-3">Google OAuth Client ID</label>
	<div class="col-9">
		<input type="text" name="google_client_id" class="form-control" value="<?php echo $konfigurasi->google_client_id ?>" placeholder="Masukkan Client ID dari Google Cloud Console">
		<small class="text-gray">Kredensial untuk fitur Login with Google. Kosongkan jika tidak menggunakan.</small>
	</div>
</div>

<div class="form-group row">
	<label class="col-3">Google OAuth Client Secret</label>
	<div class="col-9">
		<input type="text" name="google_client_secret" class="form-control" value="<?php echo $konfigurasi->google_client_secret ?>" placeholder="Masukkan Client Secret dari Google Cloud Console">
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-3">
		<input type="text" name="nama_youtube" class="form-control" value="<?php echo $konfigurasi->nama_tiktok ?>">
		<small class="text-secondary">Nama akun</small>
	</div>
	<div class="col-6">
		<input type="text" name="youtube" class="form-control" value="<?php echo $konfigurasi->tiktok?>">
		<small class="text-secondary">Alamat link akun</small>
	</div>
</div>
