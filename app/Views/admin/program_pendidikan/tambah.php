...
<form action="<?php echo base_url('admin/program_pendidikan/tambah') ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
<?php 
echo csrf_field(); 
?>

<div class="form-group row">
	<label class="col-md-2">Nama Program Pendidikan <span class="text-danger">*</span></label>
	<div class="col-md-10">
		<input type="text" name="judul_program_pendidikan" class="form-control" value="<?php echo set_value('judul_program_pendidikan') ?>" required>
	</div>
</div>
...
<div class="form-group row">
	<label class="col-md-2">Isi Program Pendidikan <span class="text-danger">*</span></label>
	<div class="col-md-10">
