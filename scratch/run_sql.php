...
$sql1 = "ALTER TABLE konfigurasi ADD COLUMN IF NOT EXISTS rincian_administrasi LONGTEXT;";
...
$sql2 = "UPDATE konfigurasi SET rincian_administrasi = '<table class=\"table table-bordered table-sm printer mt-2\">
  <thead>
    <tr>
